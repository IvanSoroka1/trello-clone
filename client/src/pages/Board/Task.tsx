                ...
                >
                    ...
                    <div className="flex flex-col items-center gap-1">
                        ...
                        <FaRegTrashAlt
                            ...
                            className={`hover:text-black ${pendingDeletion && pendingDeletion.taskId === task.id ? 'text-red-500' : ''}`}
                        ></FaRegTrashAlt>
                        <FaEdit
                            size={12}
                            onClick={() => {
                            ...
                            className={`hover:text-black ${pendingDeletion && pendingDeletion.taskId === task.id ? 'opacity-50 cursor-not-allowed' : ''}`}
                        ></FaEdit>
                    </div>
                </DraggableTask>
            )
